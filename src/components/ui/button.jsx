...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-[--color-primary] text-[--color-primary-foreground] shadow hover:opacity-90',
        destructive: 'bg-[--color-destructive] text-[--color-destructive-foreground] shadow-sm hover:opacity-90',
        outline: 'border border-[--color-input] bg-transparent shadow-sm hover:bg-[--color-accent] hover:text-[--color-accent-foreground]',
        secondary: 'bg-[--color-secondary] text-[--color-secondary-foreground] shadow-sm hover:opacity-80',
