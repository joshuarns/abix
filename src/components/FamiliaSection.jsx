...
export default function FamiliaSection() {
  return (
    <section className="w-full overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className="md:hidden" style={{ backgroundColor: '#061a20' }}>
        ...
        <div className="px-6 pt-4 pb-10 flex flex-col gap-6">
          ...
          <div className="rounded-2xl p-6 flex flex-col gap-4"
            ...
            <a
              href="https://wa.me/16012587695?text=Hola%2C%20me%20interesa%20contratar%20ABIX%20Familia%20Total" target="_blank" rel="noopener noreferrer"
      ...
      {/* ── DESKTOP ── */}
      <div className="hidden md:block relative w-full" style={{ minHeight: '700px', backgroundImage: `url(${familiaImg})`, backgroundSize: 'cover', backgroundPosition: 'center top', backgroundAttachment: 'scroll' }}>
