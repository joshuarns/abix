...
export default function HogarPlusSection() {
  return (
    <section className="w-full overflow-hidden" style={{ backgroundColor: '#f8fafc' }}>
        ...
        <div className="px-6 pt-2 pb-10 flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <a href="https://wa.me/14063441431?text=Hola%2C%20me%20interesa%20contratar%20ABIX%20Hogar%20Plus" target="_blank" rel="noopener noreferrer"
      ...
      {/* ── DESKTOP ── */}
      <div className="hidden md:block relative w-full" style={{ minHeight: '700px', backgroundImage: `url(${hogarImg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'scroll' }}>
